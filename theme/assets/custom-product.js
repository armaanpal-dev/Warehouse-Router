...
(() => {
  ...
  class ProductPage extends HTMLElement {
    ...
    render() {
      ...
      // Deep-linkable ?variant= only on the product page itself, not where the section is embedded.
      const url = new URL(window.location.href);
      if (this.dataset.updateUrl !== 'false' && url.searchParams.get('variant') !== String(v.id)) {
